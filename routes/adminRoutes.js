...
router.post('/product/new', authenticateAdmin, upload.array('images'),createProduct)
...
router.post('/category/create',authenticateAdmin, upload.array('images'),createCategories)
router.get('/categories',authenticateAdmin,getCategories)
router.get('/category',authenticateAdmin, getCategoryById)
router.put('/category/:id',authenticateAdmin,upload.array('images'), updateCategory)
