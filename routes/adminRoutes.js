...
router.delete('/product',authenticateAdmin,deleteProduct)
...
router.delete('/category',authenticateAdmin,deleteCategory)
router.get('/orders',authenticateAdmin,getAllOrders)
router.get('/order',authenticateAdmin,getOrderById)
router.delete('/order',authenticateAdmin,deleteOrder)
